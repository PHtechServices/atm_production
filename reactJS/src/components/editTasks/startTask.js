...
function FirstPage(props) {
    ...
    useEffect(() => {
        const id = props.id
                    ...
                    var config = {
                        method: 'POST',
                        url: 'http://172.17.0.2:5000/getComments',
                        headers: {
...

    {
        ...
        var config = {
            method: 'POST',
            url: 'http://172.17.0.2:5000/getjson',
            headers: {
                'Content-Type': 'application/json'
            },
            data: data
    ...
    const openTaskUpdater = (e) => {
        ...
        var config = {
            method: 'POST',
            url: 'http://172.17.0.2:5000/taskstatus',
            headers: {
                'Content-Type': 'application/json'
            },
            data: data
    ...
    const changeScreen = (e) => {
        ...
        if (startTaskPage["title"] === "Start Task") {
            ...
            var config = {
                method: 'POST',
                url: 'http://172.17.0.2:5000/updateComments',
                headers: {
                    'Content-Type': 'application/json'
                },
                data: data
